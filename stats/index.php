...
<div class="container" id="main">
	...
	<br>
    <div id="background">
		<div id="loading"><img src="../req/load.gif"></div>
    </div>
...
function output(list){
	...
	$.each(list, function( key, value ) {
		if(value["Time"]["Hours"] > 0){
			...
			var text = "<div class='closed user-stats' id='" + value["Name"] + "'> <div class='row'> <div class='col-xs-2 col-md-2 display' id='" + value["Name"] + "-display'> <img src='https://minotar.net/helm/" + value["Name"] + "/80.png' class='face'> &nbsp;&nbsp; " + value["Name"] + " </div><div class='col-xs-2 col-md-2 stat-title time' id='" + value["Name"] + "-time'> <div class='icon-circle'> <img src='../req/clock.png'> </div>" + comma(value["Time"]["Hours"]) + " Hours Played </div><div class='col-xs-2 col-md-2 stat-title ores' id='" + value["Name"] + "-ores'> <div class='icon-circle'> <img src='../req/diamond_ore.png'> </div>" + comma(value["Ores"]["Total"]) + " Ores Mined </div><div class='col-xs-2 col-md-2 stat-title break' id='" + value["Name"] + "-break'> <div class='icon-circle'> <img src='../req/grass.png'> </div>" + comma(value["Break"]["Total"]) + " Blocks Broken </div><div class='col-xs-2 col-md-2 stat-title place' id='" + value["Name"] + "-place'> <div class='icon-circle'> <img src='../req/stonebrick.png'> </div>" + comma(value["Use"]["Total"]) + " Items Used </div><div class='col-xs-2 col-md-2 stat-title kill' id='" + value["Name"] + "-kill'> <div class='icon-circle'> <img src='../req/cow.png'> </div>" + comma(value["Kill"]["Mobs"]["Total"]) + " Mobs Killed </div></div><div class='extra'> <div class='row extra-row time-hidden' id='" + value["Name"] + "-time-hidden'>" + 
			"<div class='col-sm-3 extra-info sort-by travel' id='" + value["Name"] + "-Time-Travel-Total'> <img src='../req/chainmail_boots.png'>&nbsp;&nbsp;" + comma(km) + " km Travelled </div><div class='col-sm-3 extra-info sort-by death' id='" + value["Name"] + "-Time-Deaths-Deaths'> <img src='../req/heart.png'>&nbsp;&nbsp;" + comma(value["Time"]["Deaths"]["Deaths"]) + " Deaths </div><div class='col-sm-3 extra-info sort-by cake' id='" + value["Name"] + "-Time-Cake-Slices'> <img src='../req/cake.png'>&nbsp;&nbsp;" + comma(value["Time"]["Cake"]["Slices"]) + " Slices of Cake </div></div><div class='row extra-row ores-hidden' id='" + value["Name"] + "-ores-hidden'> <div class='col-sm-3 extra-info sort-by coal-ore' id='" + value["Name"] + "-Ores-Ores-Coal'> <img src='../req/blocks/coal_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Coal"]) + " Coal Ore </div><div class='col-sm-3 extra-info sort-by iron-ore' id='" + value["Name"] + "-Ores-Ores-Iron'> <img src='../req/blocks/iron_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Iron"]) + " Iron Ore </div><div class='col-sm-3 extra-info sort-by redstone-ore' id='" + value["Name"] + "-Ores-Ores-Redstone'> <img src='../req/blocks/redstone_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Redstone"]) + " Redstone Ore </div><div class='col-sm-3 extra-info sort-by lapis-ore' id='" + value["Name"] + "-Ores-Ores-Lapis'> <img src='../req/blocks/lapis_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Lapis"]) + " Lapis Ore </div><div class='col-sm-3 extra-info sort-by gold-ore' id='" + value["Name"] + "-Ores-Ores-Gold'> <img src='../req/blocks/gold_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Gold"]) + " Gold Ore </div><div class='col-sm-3 extra-info sort-by emerald-ore' id='" + value["Name"] + "-Ores-Ores-Emerald'> <img src='../req/blocks/emerald_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Emerald"]) + " Emerald Ore </div><div class='col-sm-3 extra-info sort-by diamond-ore' id='" + value["Name"] + "-Ores-Ores-Diamond'> <img src='../req/blocks/diamond_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Diamond"]) + " Diamond Ore </div><div class='col-sm-3 extra-info sort-by quartz-ore' id='" + value["Name"] + "-Ores-Ores-Quartz'> <img src='../req/blocks/quartz_ore.png' class='block'>&nbsp;&nbsp;" + comma(value["Ores"]["Ores"]["Quartz"]) + " Quartz Ore </div><div class='col-sm-3 extra-info sort-by trade' id='" + value["Name"] + "-Ores-Trades'> <img src='../req/emerald.png'>&nbsp;&nbsp;" + comma(value["Ores"]["Trades"]) + " Villager Trades </div></div><div class='row extra-row break-hidden' id='" + value["Name"] + "-break-hidden'>"; 
			
			$.each(value["Break"]["Top10"], function( breakKey, breakVal ) {
				text += "<div class='col-sm-3 extra-info sort-by " + breakVal["Name"] + "' id='" + value["Name"] + "-Break-Top10-" + breakVal["Name"] + "'> <img src='../req/blocks/" + breakVal["Name"] + ".png' class='block'>&nbsp;&nbsp;" + comma(breakVal["Amount"]) + " " + breakVal["Name"] + " Blocks </div>";
			});
			
			text += "</div><div class='row extra-row place-hidden' id='" + value["Name"] + "-place-hidden'>";
			
			 $.each(value["Use"]["Top10"], function( useKey, useVal ) {
				text += "<div class='col-sm-3 extra-info sort-by " + useVal["Name"] + "' id='" + value["Name"] + "-Use-Top10-" + useVal["Name"] + "'> <img src='../req/blocks/" + useVal["Name"] + ".png' class='block'>&nbsp;&nbsp;" + comma(useVal["Amount"]) + " " + useVal["Name"] + "</div>";
			});
	
			 
			 text += "<div class='col-sm-3 extra-info sort-by interactions' id='" + value["Name"] + "-Use-Interactions-Total'> <img src='../req/blocks/crafting_table_front.png' class='block'>&nbsp;&nbsp;" + comma(value["Use"]["Interactions"]["Total"]) + " Block Interactions </div></div><div class='row extra-row kill-hidden' id='" + value["Name"] + "-kill-hidden'>";
			 ...
			 mobs.forEach(function(mobVal){
				 ...
				 if(killed > 0 && by > 0){
					 text += "<div class='col-sm-3 extra-info " + mobVal + "'> <img src='../req/mobs/" + mobVal + "." + ext + "'>&nbsp;&nbsp;<span class='sort-by' id='" + value["Name"] + "-Kill-Mobs-" + mobVal + "-Killed'>Killed " + killed + ",</span> <span class='sort-by' id='" + value["Name"] + "-Kill-Mobs-" + mobVal + "-By'>Killed by " + by + " </span></div>";
				 }else if(killed > 0){
					 text += "<div class='col-sm-3 extra-info sort-by " + mobVal + "' id='" + value["Name"] + "-Kill-Mobs-" + mobVal + "-Killed'> <img src='../req/mobs/" + mobVal + "." + ext + "'>&nbsp;&nbsp;Killed " + killed + "</div>";
				 }else if(by > 0){
					 text += "<div class='col-sm-3 extra-info sort-by " + mobVal + "' id='" + value["Name"] + "-Kill-Mobs-" + mobVal + "-By'> <img src='../req/mobs/" + mobVal + "." + ext + "'>&nbsp;&nbsp;Killed by " + by + " </div>";
				 }
			 });
			 
			 
			 
			 text += "<div class='col-sm-3 extra-info sort-by p-kills' id='" + value["Name"] + "-Kill-Kills-Kills'> <img src='../req/sword.png'>&nbsp;&nbsp;" + value["Kill"]["Kills"]["Kills"] + " Player Kills </div></div></div></div>";
